      ...
      <div className="home-shop-item inner-shop-item">
        <div className="home-shop-thumb">
          <a href="shop-details.html">
            <img src={require('../../assets/img/product/erythromycin-stearate-tablets_1645450996.jpg')} alt="img" />
            <span className="discount"> -10%</span>
          </a>
        </div>
        <div className="home-shop-content">
          <div className="shop-item-cat"><a href="#">Rx</a></div>
          <h4 className="title"><a href="shop-details.html">Erythromycin</a></h4>
          <span className="home-shop-price">Rs.300.00</span>
